  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        ...
        {/* 1 - ProConnect */}
        <motion.div
          className="flex flex-col md:flex-row gap-6 items-center mb-25 relative border border-[#99000080] md:border-none rounded-2xl p-2 md:p-0"
          variants={fadeInUp}
          initial="hidden"
          whileInView="visible"
        ...
        >
          ...
          >
            ...
            <img
              ...
              className="h-[160px] bottom-0 left-0 lg:h-[250px] absolute lg:static"
            />
          </a>
          ...
          <div className="w-full md:w-1/2 mt-6 md:mt-0 md:pl-10 relative">
            ...
            <ul className="list-disc ml-5 mt-2 text-gray-700">
              <li>
                Reduced page reload time to &lt;350ms with optimized React.js
        ...
        {/* 2 - Door to Mountains */}
        <motion.div
          className="flex flex-col md:flex-row-reverse gap-6 items-center mb-25 relative border border-[#99000080] md:border-none rounded-2xl p-2 md:p-0"
          variants={fadeInUp}
          initial="hidden"
          whileInView="visible"
          // viewport={{ once: true, amount: 0.2 }}
        ...
        >
          ...
          >
            ...
            <img
              ...
              className="h-[160px] bottom-0 right-0 lg:h-[250px] absolute lg:static"
            />
          </a>
          ...
          <div className="w-full md:w-1/2 mt-6 md:mt-0 md:pr-10 relative">
            ...
            <p className="text-sm mt-2 text-gray-400 font-medium">
              <span className="font-bold">Tech Used:</span> React.js,
              TailwindCSS, Swiper.js, GSAP
            </p>
            <ul className="list-disc ml-5 mt-2 text-gray-700">
              <li>Responsive travel planner website</li>
              <li>Interactive sliders with Swiper.js</li>
        ...
        >
          ...
          <div className="w-full md:w-1/2 mt-6 md:mt-0 md:pl-10 relative">
            ...
            <p className="text-sm mt-2 text-gray-400 font-medium">
              <span className="font-bold">Tech Used:</span> React.js,
              OpenWeather API, TailwindCSS
            </p>
            <ul className="list-disc ml-5 mt-2 text-gray-700">
              <li>Real-time weather updates with OpenWeather API</li>
        ...
        >
          ...
          <div className="w-full md:w-1/2 mt-6 md:mt-0 md:pr-10 relative">
            ...
            <ul className="list-disc ml-5 mt-2 text-gray-700">
              <li>Pizza ordering system with cart functionality</li>
